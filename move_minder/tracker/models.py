...
class Move(Model):
    ...
    secondary_users = models.ManyToManyField(User, related_name='moves_as_secondary')
    start_date = models.DateField()
    end_date = models.DateField(null=True, blank=True)
    origin_address1 = models.CharField(max_length=80)
    origin_address2 = models.CharField(max_length=80, null=True, blank=True)
    origin_city = models.CharField(max_length=80)
    origin_state_province = models.CharField(max_length=2, choices=state_or_province_to_abbrev)
    origin_postal_code = models.CharField(max_length=7, validators=[validate_postal_code])
    origin_country = models.CharField(max_length=40, choices={"Canada": "Canada", "USA": "USA"})
    destination_address1 = models.CharField(max_length=80)
    destination_address2 = models.CharField(max_length=80, null=True, blank=True)
    destination_city = models.CharField(max_length=80)
    destination_state_province = models.CharField(max_length=2, choices=state_or_province_to_abbrev)
    destination_postal_code = models.CharField(max_length=7, validators=[validate_postal_code])
    destination_country = models.CharField(max_length=40, choices={"Canada": "Canada", "USA": "USA"})
    created = models.DateTimeField(auto_now_add=True, blank=True)
    last_modified = models.DateTimeField(auto_now=True, blank=True)
